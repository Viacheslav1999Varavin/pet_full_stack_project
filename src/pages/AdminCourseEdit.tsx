...
import img1 from './../../public/r92.png'
...
<div className='mb-14 '>
               ...
               <form action="/admin/admin-course">
...
<div className='flex justify-center items-center flex-col mb-20'>
            <Link href="/admin/admin-course-edit/admin-add-lesson" className='bg-green rounded-full w-16 h-16 relative'> <span className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-white text-6xl '>+</span></Link>
